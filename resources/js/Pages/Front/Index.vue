...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
        <img src="../../Components/images/Logoyanti.png" class="h-20 mr-3" alt="logo" />
      <button
      ...
      <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden w-full md:block md:w-auto" id="navbarDefault">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-purple-500 md:hover:bg-transparent md:border-0 md:hover:text-purple-700 md:p-0">Home</a>
          </li>
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-purple-500 md:hover:bg-transparent md:border-0 md:hover:text-purple-700 md:p-0">About</a>
          </li>
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-purple-500 md:hover:bg-transparent md:border-0 md:hover:text-purple-700 md:p-0">Services</a>
          </li>
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-purple-500 md:hover:bg-transparent md:border-0 md:hover:text-purple-700 md:p-0">Pricing</a>
          </li>
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-purple-500 md:hover:bg-transparent md:border-0 md:hover:text-purple-700 md:p-0 mb-5">Contact</a>
          </li>
          <li>
            <div v-if="canLogin">
              <Link
                ...
                class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0">
                Dashboard
              </Link>
              <template v-else>
                <Link :href="route('login')" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0"> Log in</Link>
              </template>
            </div>
          </li>
        </ul>
      ...
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg-purple-500 hover:bg-purple-400 text-black rounded-lg px-4 py-2 mt-7">Get Started</button>
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            <img src="../../Components/images/Logoyanti.png" class="h-20 mr-3" alt=" Logo" />
            <span class="self-center text-2x font-serif whitespace-nowrap text-black uppercase">Gusti Ayu Putu Febriyanti</span>
          </div>
        </div>
